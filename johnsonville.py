...
with open ("johnsonville.csv", "r") as data: 
...
#this "if" statement defines which wells are contaminated for the JSON file
...
with open ("johnsonville.json", "w") as write_file:
	json.dump(wells, write_file, indent = 2)
	print("the Johnsonville JSON is ready")
